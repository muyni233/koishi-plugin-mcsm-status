...
var THEMES = {
  purple: {
    ...
    good: "#386A20",
    goodContainer: "#C3EFAB",
    onGoodContainer: "#042100",
    caution: "#6D5E00",
    cautionContainer: "#FBE365",
    onCautionContainer: "#211B00",
    ...
    chartMem: "#7D5260",
    chartMemFill: "rgba(125,82,96,0.16)"
  },
  blue: {
    primary: "#1B6EF3",
    onPrimary: "#fff",
    ...
    chartMem: "#006B5F",
    chartMemFill: "rgba(0,107,95,0.15)"
  },
  green: {
    primary: "#006C4C",
    onPrimary: "#fff",
    ...
    primary08: "rgba(0,108,76,0.08)",
    primary12: "rgba(0,108,76,0.12)",
    secondary: "#4D6356",
    ...
    good: "#006C4C",
    goodContainer: "#89F8C7",
    onGoodContainer: "#002115",
    caution: "#6D5E00",
    cautionContainer: "#FBE365",
    onCautionContainer: "#211B00",
    elev1: "0 1px 3px 1px rgba(0,0,0,0.12), 0 1px 2px 0 rgba(0,0,0,0.24)",
    elev2: "0 2px 6px 2px rgba(0,0,0,0.12), 0 1px 2px 0 rgba(0,0,0,0.24)",
    chartCpu: "#006C4C",
    chartCpuFill: "rgba(0,108,76,0.18)",
    chartMem: "#3D6373",
    chartMemFill: "rgba(61,99,115,0.15)"
  },
  rose: {
    primary: "#9A4057",
    onPrimary: "#fff",
    ...
    chartMem: "#7C5635",
    chartMemFill: "rgba(124,86,53,0.16)"
  },
  dark: {
    primary: "#D0BCFF",
    onPrimary: "#381E72",
    ...
    good: "#A1D395",
    goodContainer: "#1E5A0E",
    onGoodContainer: "#B7F397",
    caution: "#E4C54A",
    cautionContainer: "#514600",
    onCautionContainer: "#FBE365",
    ...
    chartMem: "#EFB8C8",
    chartMemFill: "rgba(239,184,200,0.16)"
  }
};
...
var Config = import_koishi.Schema.object({
  ...
  theme: import_koishi.Schema.union(["purple", "blue", "green", "rose", "dark"]).description("主题配色").default("blue"),
